...
import { useGetPostListQuery, useLazyGetPostByIdQuery } from "../../store/Api/postApi";
import "./MainPage.scss";
import WhatNew from "../../components/UI/WhatNew/WhatNew";
...
export const MainPage = () => {
  const [fetchTrigger,{ data, isLoading}] = useLazyGetPostByIdQuery();
  useEffect(()=>{
    fetchTrigger(null)
  },[data,fetchTrigger])
    ...
    <>
      ...
      <div className="MainPage">
        ...
        <main className="Main">
          ...
          <WhatNew onNewPostAdded={()=> fetchTrigger(null)}/>
